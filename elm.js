...
Elm.Main.make = function (_elm) {
   ...
   var app = $StartApp.start({init: $GPS.init,update: $GPS.update,view: $GPS.view,inputs: _U.list([result])});
   var main = app.html;
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",app.tasks);
   return _elm.Main.values = {_op: _op,app: app,main: main,result: result};
};
