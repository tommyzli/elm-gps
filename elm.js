...
Elm.Select.make = function (_elm) {
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.h1,
              _U.list([]),
              _U.list([A2($Html.a,
              _U.list([A2($Html$Events.onClick,address,Selected("beer"))]),
              _U.list([$Html.text("Beer")]))]))
              ,A2($Html.h1,
              _U.list([]),
              _U.list([A2($Html.a,
              _U.list([A2($Html$Events.onClick,address,Selected("wine"))]),
              _U.list([$Html.text("Wine")]))]))
              ,A2($Html.h1,
              _U.list([]),
              _U.list([A2($Html.a,
              _U.list([A2($Html$Events.onClick,address,Selected("spirit"))]),
              _U.list([$Html.text("Spirits")]))]))
              ,A2($Html.button,
              _U.list([]),
